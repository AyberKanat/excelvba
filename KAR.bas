...
Dim lcol As Variant, lrow As Variant, lcoln As String
    ...
    With NewWorkbook
        ...
        .SaveAs Filename:="C:\Users\akanat\Desktop\Tools\KsK" + "\" + Format(Date, "dd mmmm yyyy") + "_" + "BHM Mart  18 BHM Kontrol v1" + "_" + excl_name + ".xls"
    End With
...
ThisWorkbook.Sheets("CriteriaValues").Activate
